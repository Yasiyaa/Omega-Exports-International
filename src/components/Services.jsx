...
export default function Services({ onOpenQuote }) {
  ...
  return (
    <section id="services" className="py-24 bg-warm-100 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {SERVICES.map((srv, index) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-8 shadow-executive hover:shadow-executive-hover border border-warm-300 transition-all duration-300 flex flex-col justify-between group"
            >
              <div className="space-y-5">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-2xl bg-warm-100 border border-gold-300/60 flex items-center justify-center shadow-inner group-hover:bg-gold-500 group-hover:text-white transition-colors duration-300">
              ...
              <div className="pt-6 mt-6 border-t border-warm-200">
                <button
                  onClick={() => onOpenQuote()}
                  className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-navy-900 hover:text-gold-600 transition-colors"
                >

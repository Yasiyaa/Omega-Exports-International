...
export default function Contact({ onOpenQuote }) {
  ...
  return (
    <section id="contact" className="py-24 bg-warm-100 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gold-100 text-gold-600 text-xs font-semibold uppercase tracking-widest border border-gold-300">
            <Mail className="w-3.5 h-3.5" />
            <span>Connect With Us</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold text-navy-900 tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-navy-900 rounded-2xl p-8 text-white shadow-xl border border-gold-500/20 space-y-6">
              <div>
                <span className="text-xs uppercase tracking-widest text-gold-400 font-bold">Trade Enquiries</span>
                <h3 className="text-2xl font-serif font-bold text-white mt-1">Omega Exports Trade Office</h3>
              ...
              <div className="space-y-4 pt-4 border-t border-slate-800 text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-xs text-slate-400 block font-medium">Export Inquiries Email</span>
                    <span className="font-medium text-white">trade@omegaexports.com</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-xs text-slate-400 block font-medium">Global Trade Line</span>
              ...
              <div className="pt-4 border-t border-slate-800">
                <button
                  onClick={() => onOpenQuote()}
                  className="w-full py-3.5 bg-gold-gradient text-white text-xs uppercase tracking-wider font-semibold rounded-xl shadow-lg hover:opacity-95 transition-all text-center block"
                >
            ...
            <div className="bg-white p-6 rounded-2xl border border-warm-300 shadow-sm space-y-3">
          ...
          <div className="lg:col-span-7 bg-white rounded-2xl p-8 shadow-executive border border-warm-300">
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                <div className="w-16 h-16 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto">
                  <CheckCircle2 className="w-10 h-10" />
                </div>
                <h3 className="text-2xl font-serif font-bold text-navy-900">Message Sent Successfully</h3>
                ...
                <button
                  ...
                  className="mt-4 px-6 py-2.5 bg-navy-900 text-white text-xs font-semibold rounded-xl"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <h3 className="text-xl font-serif font-bold text-navy-900 mb-2">Send a General Inquiry</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-warm-50 border border-warm-300 rounded-xl text-sm text-slate-800 focus:ring-2 focus:ring-gold-500 focus:bg-white focus:outline-none"
                    />
                  </div>
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full sm:w-auto px-8 py-3 bg-navy-900 hover:bg-navy-800 text-white font-semibold text-sm rounded-xl shadow-md transition-all flex items-center justify-center gap-2"
                  >

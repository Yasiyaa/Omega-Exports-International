...
export default function Solutions({ onOpenQuote }) {
  ...
  return (
    <section id="solutions" className="py-24 bg-navy-950 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-navy-900 border border-gold-500/30 text-gold-400 text-xs font-semibold uppercase tracking-widest">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {SOLUTIONS.map((sol, index) => (
            <motion.div
              ...
              className="bg-navy-900/80 rounded-2xl p-8 border border-gold-500/20 hover:border-gold-500/50 shadow-xl backdrop-blur-md flex flex-col justify-between group hover:-translate-y-1 transition-all duration-300"
            >
              <div className="space-y-6">
                
                {/* Header Icon */}
                <div className="w-14 h-14 rounded-2xl bg-navy-950 border border-gold-500/30 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                  {getIcon(sol.icon)}
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gold-400/90 font-medium uppercase tracking-wider mt-1">
                    {sol.subtitle}
                  </p>
                </div>
              ...
              <div className="pt-8">
                <button
                  onClick={() => onOpenQuote()}
                  className="w-full py-3 bg-navy-950 hover:bg-gold-gradient text-white text-xs font-semibold uppercase tracking-wider rounded-xl border border-gold-500/30 hover:border-transparent transition-all flex items-center justify-center gap-2 group-hover:shadow-lg"
                >

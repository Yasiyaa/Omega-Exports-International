    ...
    <section id="about" className="py-16 sm:py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16 space-y-3 sm:space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-gold-100 text-gold-600 text-[11px] sm:text-xs font-semibold uppercase tracking-widest border border-gold-300">
            <Compass className="w-3.5 h-3.5" />
            <span>Company Overview</span>
          </div>
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-serif font-bold text-navy-900 tracking-tight leading-tight">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="lg:col-span-6 relative rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border border-gold-500/30 h-48 sm:h-96 group">
                ...
                <div className="absolute top-3 left-3 sm:top-4 sm:left-4 bg-navy-900/90 text-gold-300 text-[10px] sm:text-xs uppercase tracking-wider font-bold px-3 py-1 rounded-lg border border-gold-500/30 backdrop-blur-md">

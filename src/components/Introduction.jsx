    ...
    <section id="introduction" className="py-16 sm:py-24 bg-[#faf8f5] text-navy-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12 sm:space-y-16">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4">
          <div className="inline-flex items-center px-4 py-1 rounded-full bg-gold-500/15 border border-gold-500/30 text-gold-800 text-xs font-semibold uppercase tracking-widest">

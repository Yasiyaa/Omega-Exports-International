...
export default function Products({ onOpenQuote }) {
  ...
  return (
    <section id="products" className="py-24 bg-warm-100 relative">
        ...
        <div className="flex items-center justify-center flex-wrap gap-2 sm:gap-3 mb-12">
          {PRODUCT_CATEGORIES.map((cat) => (
            <button
              ...
              className={`px-5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition-all shadow-sm ${
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden bg-slate-900">
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1 rounded-md bg-navy-900/90 text-gold-300 text-xs font-semibold uppercase tracking-wider backdrop-blur-md border border-gold-500/30">
              ...
              <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                ...
                <div className="bg-warm-50 p-3 rounded-xl border border-warm-200 space-y-1.5 text-xs">
                  <div className="flex items-center justify-between text-slate-700">
                    <span className="flex items-center gap-1.5 font-medium">
                      <Thermometer className="w-3.5 h-3.5 text-gold-500" />
                      Storage Temp:
                    </span>
                    <span className="font-semibold text-navy-900">{product.specs[0].value.split('/')[0]}</span>
                  </div>
                  <div className="flex items-center justify-between text-slate-700">
                    <span className="flex items-center gap-1.5 font-medium">
                ...
                <div className="pt-2 flex items-center gap-3">
                  <button
                    ...
                    className="flex-1 py-2.5 px-3 bg-warm-100 hover:bg-warm-200 text-navy-900 text-xs font-semibold rounded-xl border border-warm-300 transition-colors flex items-center justify-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 px-3 bg-gold-gradient hover:opacity-95 text-white text-xs font-semibold rounded-xl shadow-md shadow-gold-500/20 transition-all flex items-center justify-center gap-1.5"
                  >
